...
struct ts_table_s {
	ts_table_key_t (*lookup)(void *ptr, size_t len);
...
int ts_table_add(void *ptr, size_t len, struct ts_table_s *table);
int ts_table_rem(void *ptr, size_t len, struct ts_table_s *table);
